...
pygame.display.set_caption("Selection Sort - dot.mp3 + spiki.mp3")
...
def selection_sort(arr):
    ...
    for i in range(n):
        ...
        for j in range(i + 1, n):
            comps += 1
            yield min_idx, j, comps, swaps, "compare"
...
while running:
    ...
    info = f"Selection Sort  Comparisons: {comparisons} | Swaps: {swaps} | Time: {elapsed:.2f}s  [R] reset"
