...
pygame.display.set_caption("SSA - dot.mp3 + spiki.mp3")
...
try:
    ...
    print("[OK] dot.mp3 Loaded")
except Exception:
    dot_base_sound = None
    print("[!] dot.mp3 is not exist")
...
while running:
    ...
    info = f"Bubble Sort  Comparisons: {comparisons} | Swaps: {swaps} | Time: {elapsed:.2f}s  [R] reset"
