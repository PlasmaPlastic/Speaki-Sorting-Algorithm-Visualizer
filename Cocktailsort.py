...
pygame.display.set_caption("Cocktail Sort - dot.mp3 + spiki.mp3")
    ...
    while swapped:
        ...
        for i in range(start, end):
            ...
            if arr[i]["idx"] > arr[i + 1]["idx"]:
                ...
                yield i, i + 1, comps, swaps, "compare"
        if not swapped:
            break
        end -= 1
...
while running:
    ...
    info = f"Cocktail Sort  Comparisons: {comparisons} | Swaps: {swaps} | Time: {elapsed:.2f}s  [R] reset"
